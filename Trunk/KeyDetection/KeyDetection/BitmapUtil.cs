...
namespace KeyDetection
{
    public class BitmapUtil
    {
        ...
        public static float[] GetDistanceAndAngle(UnsafeBitmap uBmp, Line edge)
        {
        ...
        public static UnsafeBitmap BlackWhite(UnsafeBitmap uBmp, double satThreshold = -1)
        {
            if (satThreshold <= 0)
                satThreshold = Globals.SAT_THRESHOLD;
