...
#define MPU6000_CHIP_SELECT_PIN 4  // MPU6000 CHIP SELECT ON APM 2.0
...
class MPU6000_Class
{
  public:
        ...
        void init();           // MPU6000 initialization
    ...
    void set_dmp_rate(uint8_t rate);  // set DMP output rate (see constants)
        ...
        void calculate();      // Read quaternion data and calculate DCM and euler angles
