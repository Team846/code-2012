#define MAGNETIC_DECLINATION -14.0    // not used now -> magnetic bearing 
...
void Compass_Heading()
{
  ...
  cos_roll = cos(MPU6000.MPU_roll);
  sin_roll = sin(MPU6000.MPU_roll);
  cos_pitch = cos(MPU6000.MPU_pitch);
  sin_pitch = sin(MPU6000.MPU_pitch);
