...
#ifndef __ARDUIMU_I2C_h__
#define __ARDUIMU_I2C_h__
...
/**
 * ARDUIMU Accelerometer on I2C.
 * 
 * This class alows access to an Arduini IMU 3-axis accelerometer / gyro on an I2C bus.
 * This class assumes the default (not alternate) sensor address of 0x3A (8-bit address).
 */
class ARDUIMU_I2C : public SensorBase
{
protected:
...
public:
	explicit ARDUIMU_I2C(UINT8 moduleNumber, DataFormat_Range range=kRange_2G);
	virtual ~ARDUIMU_I2C();
