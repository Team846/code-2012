 ...
 * As of February 5th, 1:30 AM, this code is not properly working yet.
 *
 * TO-DO:
 * - Decide on an algorithm! (probably going to be Sobel Edge Detection)
 * - Implement algorithm
 * 
 * CURRENT STATUS:
 * - Sobel is BROKEN!
 * - Longest-row works, but has about a +/- 15 y accuracy -- 30 is far too much!
 */
...
namespace KeyDetection
{
    ...
    class Program
    {
        static PixelData redHigh = new PixelData(71, 33, 54); //if we have a red key
        ...
        static void Main(string[] args)
        {
            ...
            unsafeFrame.Bitmap.Save("frameout.jpg", ImageFormat.Jpeg);
