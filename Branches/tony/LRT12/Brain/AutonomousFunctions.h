...
public:
	...
	enum autonomousStage
	{
		...
		DELAY_HALF_SEC = 10,
		ADJUSTABLE_DELAY = 11,
		DANCE = 12, //!< spin in circles while moving the ball collector up and down
		DONE = 0
	//!< Finished
	};
...
private:
	...
	const static int SHOOT_THEN_BRIDGE_THEN_DANCE_LENGTH = 11;
	const static autonomousStage SHOOT_THEN_BRIDGE_THEN_DANCE[SHOOT_THEN_BRIDGE_THEN_DANCE_LENGTH];
